...
export default function MonthPicker(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "MonthPicker")}
    >
      <Flex
        gap="0"
        direction="row"
      ...
      >
        ...
        >
          ...
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "selectorIcon30883824")}
          >
            <Icon
              width="9.33349609375px"
              height="5.291015625px"
              viewBox={{
                minX: 0,
                minY: 0,
                width: 9.33349609375,
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "line30883825")}
            ></Icon>
          </View>
        </Flex>
        <Flex
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "selectorIcon30883827")}
          >
            <Icon
              width="7.93798828125px"
              height="14px"
              viewBox={{ minX: 0, minY: 0, width: 7.93798828125, height: 14 }}
              paths={[
                {
              ...
              {...getOverrideProps(overrides, "line30883828")}
            ></Icon>
          </View>
          <View
            width="24px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "selectorIcon30883829")}
          >
            <Icon
              width="7.93798828125px"
              height="14px"
              ...
              transformOrigin="top left"
              transform="rotate(-90deg)"
              {...getOverrideProps(overrides, "line30883830")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "monthOptions")}
      ></Flex>
    </Flex>
  );
}
