    ...
    >
        ...
        >
          ...
          >
            <Icon
              ...
              type="arrow_forward"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconlgl")}
            ></Icon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharegkg")}
            ></Text>
            <Icon
              width="24px"
              height="24px"
              ...
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconiam")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="share"
              fontSize="24px"
              {...getOverrideProps(overrides, "Icontny")}
            ></Icon>
            <Icon
              width="24px"
              height="24px"
              ...
              type="more_vert"
              fontSize="24px"
              {...getOverrideProps(overrides, "Iconhwa")}
            ></Icon>
          </Flex>
        </Flex>
        <Image
      ...
      >
        <Icon
          ...
          type="arrow_forward"
          fontSize="24px"
          {...getOverrideProps(overrides, "Icontvf")}
        ></Icon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moreghi")}
        ></Text>
      </Flex>
    </Flex>
  );
