...
export default function Journalpost2(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "Journalpost2")}
    >
      <Flex
        gap="16px"
        position="absolute"
        ...
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read more31643926")}
      >
        <Icon
          width="24px"
          height="24px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read more31643928")}
        ></Text>
      </Flex>
      <Image
        width="160px"
