  ...
  return (
    ...
    >
      ...
      <SelectField
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "SelectFielduzo")}
      ></SelectField>
      <TextField
        display="flex"
        gap="4px"
        ...
        variation="default"
        isMultiline={false}
        {...getOverrideProps(overrides, "TextFieldqvb")}
      ></TextField>
      <SelectField
        display="flex"
        gap="4px"
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "SelectFieldfvr")}
      ></SelectField>
      <TextField
        display="flex"
        gap="4px"
        ...
        variation="default"
        isMultiline={false}
        {...getOverrideProps(overrides, "TextFieldurf")}
      ></TextField>
      <TextField
        display="flex"
        gap="4px"
        ...
        variation="default"
        isMultiline={false}
        {...getOverrideProps(overrides, "TextFieldmul")}
      ></TextField>
      <Button
        display="flex"
        gap="10px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 28bbd")}
        >
          <Icon
            width="24px"
            height="24px"
            ...
            type="camera"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconoja")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="14px"
        ...
        >
          <Icon
            ...
            type="flag"
            fontSize="24px"
            {...getOverrideProps(overrides, "Iconndb")}
          ></Icon>
          <Text
            fontFamily="Inter"
            fontSize="14px"
